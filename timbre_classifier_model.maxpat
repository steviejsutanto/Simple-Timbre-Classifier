...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 772.5, 72.5, 107.0, 20.0 ],
					"text" : "n4m - tfjs example"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 128.0, 236.0, 119.0, 20.0 ],
					"text" : "turn on predict mode"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 757.5, 109.0, 137.0, 33.0 ],
					"text" : "Stevie J. Sutanto\nwww.steviejsutanto.com",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 660.0, 30.0, 332.0, 40.0 ],
					"text" : "Simple Timbre Classifier"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 51.0, 112.0, 64.0, 22.0 ],
									"text" : "clip~ -1. 1."
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 185.0, 259.0, 208.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 185.0, 161.0, 42.0, 22.0 ],
									"text" : "output"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 185.0, 131.0, 63.0, 22.0 ],
									"text" : "qmetro 30"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 254.0, 398.5, 92.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 290.0, 206.0, 146.0, 22.0 ],
									"text" : "buffer~ 16bin @samps 16"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 458.0, 161.0, 91.0, 22.0 ],
									"text" : "outputlength $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 383.0, 161.0, 73.0, 22.0 ],
									"text" : "listlength $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 185.0, 299.0, 41.0, 22.0 ],
									"text" : "jit.spill"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 290.0, 126.0, 33.0, 22.0 ],
									"text" : "* 0.5"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 290.0, 100.0, 47.0, 22.0 ],
									"text" : "r fftsize"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 290.0, 161.0, 91.0, 22.0 ],
									"text" : "sizeinsamps $1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 185.0, 428.5, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 254.0, 428.5, 30.0, 30.0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-17", 0 ],
									"midpoints" : [ 392.5, 201.0, 420.0, 201.0, 420.0, 294.0, 194.5, 294.0 ],
									"source" : [ "obj-19", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 467.5, 200.0, 194.5, 200.0 ],
									"source" : [ "obj-28", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 299.5, 155.0, 392.5, 155.0 ],
									"order" : 1,
									"source" : [ "obj-36", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 299.5, 155.0, 467.5, 155.0 ],
									"order" : 0,
									"source" : [ "obj-36", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-14", 0 ],
									"midpoints" : [ 299.5, 185.0, 239.0, 185.0, 239.0, 200.0, 194.5, 200.0 ],
									"source" : [ "obj-37", 0 ]
								}
...
,
					"patching_rect" : [ 30.0, 270.0, 91.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 30.0, 315.0, 165.0, 75.0 ],
					"setminmax" : [ 0.0, 1.0 ],
					"setstyle" : 1,
					"size" : 16
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 60.0, 120.0, 15.0, 60.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 30.0, 60.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 102.0, 236.0, 24.0, 24.0 ]
				}
